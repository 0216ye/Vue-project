<template>
  <div class="shop-header">
    <nav class="shop-nav" @click="$router.replace('/home')" :style="{backgroundImage:`url(${info.bgImg}`}">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="isShowBulletin">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="isShowBulletin=false"><span class="iconfont iconclose"></span></div>
        </div>
        <div class="brief-modal-cover" @click="isShowBulletin=false"></div>
      </div>
    </transition>

    <transition naem ="move">
      <div class="activity-sheet"  v-show="isShowSupports">
        <div class="activity-sheet-content">
          <h2 class="activity-sheet-title">优惠活动</h2>
          <ul class="list">
            <li class="activity-item activity-green" :class="supportsClasses[info.supports[index].type]" v-for="(item,index) in info.supports" :key="index">
              <span class="content-tag">
